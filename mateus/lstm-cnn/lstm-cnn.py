...
l_lstm = LSTM(64, return_sequences=True, recurrent_activation='hard_sigmoid', dropout=0.3)(embedded_sequences)

l_cov1 = Conv1D(128, 5, activation='relu', padding='same')(l_lstm)
l_dropout1 = Dropout(0.3)(l_cov1)
l_pool1 = GlobalMaxPooling1D()(l_dropout1)

preds = Dense(5, activation='softmax')(l_pool1)
